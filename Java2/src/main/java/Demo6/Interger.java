 ...
 * @author USER
 */
public class Interger extends javax.swing.JFrame {

    /**
     * Creates new form Interger
     */
    public Interger() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Interger.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
